    ...
    return (
      <div className="absolute" >
        <Navbar className={`text-navbar-transparent ${!this.state.isTop ? 'navbar-transparent-scrolled' : ''}`} staticTop collapseOnSelect inverse>
          <Navbar.Header>
            <Navbar.Brand>
              <Link to="/"><h5 className="logo-font">LEARNSPACE</h5></Link>
            </Navbar.Brand>
            <Navbar.Toggle />
          </Navbar.Header>
          <Navbar.Collapse>
            ...
            <NavItem>
              ...
              <NavItem>
                <NavLink to="/about">
                  <span className="small"><h5><strong>About</strong></h5></span>
                </NavLink>
              </NavItem>
              {
                ...
                <Nav>
                  <NavItem>
                    <NavLink to="/login">
                    <span className="small"><h5><strong>Login</strong></h5></span>
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <Link to="/signup">
                ...
                :
                  ...
                  <NavItem >
                  <Link to="">
                  <span className="small"><h5><strong>{this.props.userEmail}</strong></h5></span>
                  </Link>
                  </NavItem>
                  <NavItem >
                    <span className="" className="small"><h5><FontAwesomeIcon icon="user" size='1x' /></h5></span>
                  </NavItem>
                  <NavItem >
